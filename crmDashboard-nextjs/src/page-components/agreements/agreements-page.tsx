    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage all your business agreements and contracts
          </p>
        </div>
        <Button>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{sampleAgreements.length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {sampleAgreements.filter(a => a.status === "active").length}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              Currently active
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {sampleAgreements.filter(a => a.status === "expired").length}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              Need renewal
            </p>
